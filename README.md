...
```
npm install @chainup-custody/js-wapi-sdk@1.0.1
```

How to use:

```
const Cons = require('@chainup-custody/js-wapi-sdk/utils/Constants');
const addrApi = require('@chainup-custody/js-wapi-sdk/apidao/AddressRegisterApi');
const depositNotify = require('@chainup-custody/js-wapi-sdk/apidao/DepositNotifyApi');
const withdraw = require('@chainup-custody/js-wapi-sdk/apidao/WithdrawApi');
